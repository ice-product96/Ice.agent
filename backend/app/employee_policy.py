...
def pm_system_instruction() -> str:
    ...
    return (
        ...
        "A card already on the customer ice_tracker board IS the request: do not ask "
        "them to confirm starting work or to re-approve the card. Structure, estimate "
        "internally, then submit_development_task. "
